...
def train_with_config(args, opts):
    ...
    """
    # Global unstructured(i.e., weight) 프루닝 실행
    parameters_to_prune = ()
    pruning_amount = 0.8
    for i in range (5): 
        parameters_to_prune += (
...
if __name__ == "__main__":
    ...
    #model_backbone.eval()
    #print(model_backbone.state_dict().keys())
    #torch.save(model_backbone.state_dict(),"pruned.model")
    ...
    print("Sparsity: {:.4f}%".format(100. * float(numerator) / float(denominator)))
