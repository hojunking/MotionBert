...
if __name__ == "__main__":
    ...
    for name, module in model_backbone.named_modules():
        ...
        model_params_pruning = model_params + parameter.numel()
    print ("sparsity is ")
    #print('INFO: L1_norm pruning parameter count:', model_params_pruning)
    
    print(model_backbone.blocks_st.attention)
